            ...
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="{{asset('upload/'.$joueur->profile)}}" class="img-circle" width="150" height="150" />
                        ...
                        <h6 class="card-subtitle" style="text-transform: uppercase">{{$joueur->datedenaissance   }}</h6>
                        <div class="row text-center justify-content-md-center">
                            <div class=""><a href="javascript:void(0)" class="link main-color"><i class="icon-people"></i> <font class="font-medium">Inscris depuis le: {{$joueur->created_at}}</font></a></div>
                        </div>
                    </center>
                </div>
                <div>
